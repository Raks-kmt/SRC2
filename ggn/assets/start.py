...
async def start(event):
    ...
    collection.update_one({"user_id": user_id}, {"$set": {"user_id": user_id}}, upsert=True)
    buttons = [
        [Button.url("Join Channel", url="https://t.me/forcesub12")],
        [Button.url("Contact Me", url="https://t.me/forcesub12")],
    ]
...
async def term_command(event):
    # Creating inline keyboard with buttons
    buttons = [
        [Button.url("Query?", url="https://t.me/forcesub12"),
         Button.url("Channel", url="https://t.me/forcesub12")]
    ]
...
REPO_URL = "https://t.me/forcesub12"
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Advance Content Saver Bot](https://t.me/forcesub12)**__"  # Set caption to the title of the video
